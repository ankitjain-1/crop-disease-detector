...
filepath = '/home/ankit/Documents/python/crop-disease-detector'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread('/home/ankit/Documents/python/crop-disease-detector/Dataset/test/Tomato___Bacterial_spot (1).JPG')
